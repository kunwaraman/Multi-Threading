...
class Task2 implements Runnable{
    ...
    @Override
    public void run() {
        synchronized (pen) { // thread2 papaer par lock tabhi lagaye jab ushke paas pen ka lock ho
...
/*
ish case main dono ne lock laga rakha hai aur koshis kar rha hai acquire karne ki
to ye ek dushre par depend kar rhe hai
 */
